...
import SystemHealth from '../components/os/SystemHealth'; // Import the new SystemHealth
import { Cog, Palette, Mic, Activity } from 'lucide-react';
...
const SettingsApp: React.FC = () => {
    ...
    const tabs = [
        ...
        { id: 'system', label: currentText.system, icon: Activity },
    ];
